...
base_urlcpf = "http://localhost:5000/validacpf/%s"

while True:

    operacao = input("Escolha uma operação (GET, POST, PUT, DELETE, CPF, SAIR): ")
    ...
    elif operacao.upper() == "CPF":
        cpf = input("CPF: ")
        response = requests.post(base_urlcpf % cpf)
